...
public class EntryLogButtonControl extends JPanel implements ActionListener
{
	...
	//Constructor
	public EntryLogButtonControl(EntryLog entryLog, boolean next, String componentName, String text)
	{
		//Initialization
