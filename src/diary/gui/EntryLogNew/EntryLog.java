...
import diary.gui.EntryLogNew.forms.ActiveUser;
import diary.gui.EntryLogNew.forms.Comments;
import diary.gui.EntryLogNew.forms.DateTimeSelect;
import diary.gui.EntryLogNew.forms.Duration;
import diary.gui.EntryLogNew.forms.FormElement;
import diary.gui.EntryLogNew.forms.Intensity;
import diary.gui.EntryLogNew.forms.PainKind;
import diary.gui.EntryLogNew.forms.PainLocation;
import diary.gui.EntryLogNew.forms.RecentMedication;
import diary.interfaces.GUIFunction;
import diary.methods.Methods;

public class EntryLog extends JPanel implements GUIFunction, ActionListener
{
